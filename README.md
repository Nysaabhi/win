...
.filter-container {
    ...
    padding: 24px 0;
    margin-bottom: 16px;
    gap: 0px; /* More consistent spacing between buttons */
}
...
.filter-btn {
    padding: 14px 32px; /* Slightly reduced padding for better proportions */
    font-family: 'Poppins', sans-serif;
    font-size: 15px; /* More refined size */
    font-weight: 500; /* Slightly reduced weight for elegance */
    ...
    margin-right: 12px;
    flex-shrink: 0;
    text-transform: capitalize; /* Changed from uppercase for better readability */
